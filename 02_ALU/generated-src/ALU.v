module ALU(
  ...
  wire [62:0] _GEN_0 = {{31'd0}, io_operandA}; // @[ALU.scala 82:36]
  wire [62:0] _io_aluResult_T_7 = _GEN_0 << shift_amount; // @[ALU.scala 82:36]
  wire [31:0] _io_aluResult_T_8 = io_operandA >> shift_amount; // @[ALU.scala 86:35]
  wire [31:0] _io_aluResult_T_9 = io_operandA; // @[ALU.scala 89:36]
  wire [31:0] _io_aluResult_T_11 = $signed(io_operandA) >>> shift_amount; // @[ALU.scala 89:60]
  wire [31:0] _io_aluResult_T_13 = io_operandB; // @[ALU.scala 92:57]
  wire [31:0] _GEN_1 = 4'ha == io_operation ? io_operandB : 32'h0; // @[ALU.scala 44:16 49:24 98:20]
  wire [31:0] _GEN_2 = 4'h9 == io_operation ? {{31'd0}, _T_6} : _GEN_1; // @[ALU.scala 49:24 95:20]
  wire [31:0] _GEN_3 = 4'h8 == io_operation ? {{31'd0}, $signed(_io_aluResult_T_9) < $signed(_io_aluResult_T_13)} :
    _GEN_2; // @[ALU.scala 49:24 92:20]
  wire [31:0] _GEN_4 = 4'h7 == io_operation ? _io_aluResult_T_11 : _GEN_3; // @[ALU.scala 49:24 89:20]
  wire [31:0] _GEN_5 = 4'h6 == io_operation ? _io_aluResult_T_8 : _GEN_4; // @[ALU.scala 49:24 86:20]
  wire [62:0] _GEN_6 = 4'h5 == io_operation ? _io_aluResult_T_7 : {{31'd0}, _GEN_5}; // @[ALU.scala 49:24 82:20]
